...
func (les *LocalStorage) AddEvent(e events.Event) (int, error) {
...
func (les *LocalStorage) GetEvent(eventID int) (events.Event, error) {
...
func (les *LocalStorage) ReplaceEvent(eventID int, e events.Event) error {
...
func (les LocalStorage) EventList() map[int]events.Event {
	return les.Events
}
